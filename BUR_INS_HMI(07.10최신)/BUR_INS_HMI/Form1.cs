    ...
    public partial class Form1 : Form
    {
        ...
        private void SaveDataToCSV(ushort[] data)
        {
            ...
            if (!File.Exists(csvFilePath))
            {
                ...
                {
                    sw.WriteLine("Timestamp,Value1,Value2,Value3,value4,value5,value6,value7"); // 헤더
                }
            }
        ...
        private void rpm_check(ushort[] data)
        {
            ...
            for (int i = 0; i < 27; i++)    //교정중이랑 RPm visible은 별개로 처리하도록 수정하기
            {
                ...
                roll_pan.roll_rpm[i].Visible = (avg >= target_rpm[0]) ? true : false;  // 조건에 따라 true 또는 false
            }
        ...
        private void roll_check(ushort[] data)
        {
            ...
            if (data[2] == 1 && get_message == false)  //한번뜨고나서 다시 띄우려니안됨.
            {
                ...
                */
                   ...
                   f5 = new Form5(this, "RED");
                //   f5.ShowDialog();   //UI 실시간 반영안됨. 제외
                f5.TopMost = true;
                f5.Show();
                f5.TopMost = true;
                //    f5.Show();    //show면 되긴하는데 x대신 그냥 f1을 위로 올리면 답없음
