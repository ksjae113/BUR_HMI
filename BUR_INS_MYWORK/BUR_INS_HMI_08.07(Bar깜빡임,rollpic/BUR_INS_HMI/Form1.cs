...
namespace BUR_INS_HMI
{
    public partial class Form1 : Form
    {
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            roll = new Panel[] { roll6,roll7,roll8,roll9,
            ...
            //    label97.BackColor = Color.FromArgb(34, 177, 76);  초록
            //    label98.BackColor = Color.FromArgb(237, 28, 36);  빨강
            // 255,255,0 노랑
        }
            ...
            /*   Color[] colors =
       {
        ...
        private void roll_rpm1_Click(object sender, EventArgs e)
        {

        }

        private void stat_panel_Paint(object sender, PaintEventArgs e)
        {
