    ...
    public partial class Form3 : Form
    {
     ...
     //   internal void update_Realamp(decimal[] a, int index)
        ...
        private void DiseaseUpdateEventMethodF4toF3(object sender, object unit)  //f4 입력에 맞춰 업데이트
        {
            ...
            {
             /*   bool slave_stat = true;

                if (_mainForm._modbusMaster != null)    //연결 되어 있는 경우
                {
                    try
                    {
                    ...
                    {
                        slave_stat = false;
                        MessageBox.Show("1번 장치 RPM 주기 변경 실패", "장치[1] 연결 확인");
                    }
                    ...
                    {
                        slave_stat = false;
                        MessageBox.Show("2번 장치 RPM 주기 변경 실패", "장치[2] 연결 확인");
                    }
                    ...
                    MessageBox.Show("RPM 주기를 변경할 수 없습니다.", "장치[1],[2] 연결 확인");*/
