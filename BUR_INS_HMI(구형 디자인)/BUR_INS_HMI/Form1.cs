...
namespace BUR_INS_HMI
{
    public partial class Form1 : Form
    {
                  ...
                  if (buffer.Length >= 8)
                    {
                        ...
                        if (buffer[7] == 0x01)
                        {
                            ...
                            //    sen_err(roll[0], 0);
                            sens_check(buffer[7],7);
                            roll_check(buffer[7],7);
                            if (f3 == null || f3.IsDisposed)
                                f3 = new Form3();
                            f3.updateAmpare(buffer[7]);
                        }
                        ...
                        else if (buffer[2] == 0x01)
                        {
                            ...
                            sens_check(buffer[2],2);
                            roll_check(buffer[2],2);
                            if (f3 == null || f3.IsDisposed)
                                f3 = new Form3();
                            f3.updateAmpare(buffer[2]);
                        }
                        else if (buffer[2] == 0x00 && buffer[7] == 0x00)
                        {
                            ...
                            sens_check(buffer[2],0);
                            roll_check(buffer[2],0);
                            if (f3 == null || f3.IsDisposed)
                                f3 = new Form3();
                            f3.updateAmpare(buffer[2]);
                        }
        ...
        private void roll_check(byte data, int index)
        {
           /* for (int i = 0; i < 27; i++)
            {
                if (index == 7 && data == 0x01)
                {
                    roll[1].BackColor = Color.Yellow;
                }
                else if (index == 2 && data == 0x01)
                {
                    roll[0].BackColor = Color.Red;
                }
                else
                {
