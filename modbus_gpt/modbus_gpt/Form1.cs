...
namespace modbus_gpt        //Turn on 하면 0받아서 켜지고 off하면 1받아서 꺼지기 성공
{
    ...
    public partial class Form1 : Form       
    {
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            _modbusMaster.Transport.ReadTimeout = 50;
        }
        ...
        private void btnReadDI_Click(object sender, EventArgs e)
        {
            ...
            ushort[] inputData = _modbusMaster.ReadHoldingRegisters(slaveId, startAddress, numInputs);
            //   while (true)
            //  {
            //    inputData = _modbusMaster.ReadInputRegisters(slaveId, startAddress, numInputs);
        ...
        {
            _modbusMaster.WriteSingleRegister(3, 10, 1);
            //      WritePort3Led(1); 
      ...
      /*  private byte[] BuildWriteSingleRegisterFrame(byte slaveId, ushort registerAddress, ushort value)
        ...
        {
            //  WritePort3Led(0); //
            _modbusMaster.WriteSingleRegister(3, 10, 0);
        }
        ...
        private void WritePort3Led(ushort value)
        {
            ...
            {
                byte slaveId = 3;
                ushort address = 0x0010; // Port3 LED 제어 주소
