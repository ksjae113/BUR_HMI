...
namespace BUR_INS_HMI
{
    public partial class Form1 : Form
    {
       ...
       internal decimal target_rpm = 0;
        ...
        private void update_info(ushort[] data)
        {
            ...
            for (int i = 0; i < 8; i++)
            {
                info_lbl[i].Text = amp[i].ToString();
            }
        }
   ...
   /*     private async Task SaveModbusDataAsync(ushort[] data)
        ...
        private void roll_check(ushort[] data)
        {
            ...
            int green_min = (int)(target_rpm - (target_rpm * 0.1M));
            int green_max = (int)(target_rpm + (target_rpm * 0.1M));
            int yellow = 15;
     ...
     /*   private void logout_btn_Click(object sender, EventArgs e)
        ...
        private void DiseaseUpdateEventMethodF2toF1(object sender)
        {
            ...
            //    f2.edit_panel.Visible = true; f2에서 해야 먹힘
